/**
 * Dynamic Twitter/X Card Image — Auto-generated social preview for Twitter shares.
 *
 * WHY THIS FILE EXISTS:
 * Twitter/X uses `twitter:image` (this file) preferentially over `og:image`
 * when both are present. By providing a dedicated Twitter image, we ensure
 * optimal rendering in Twitter's summary_large_image card format.
 *
 * HOW IT WORKS:
