...
# Symply AI subdomain clones — aligned with CLONE-FLEET-REGISTRY.md
# Updated 2026-04-14 (custom3-pane1776): added 12 missing registry entries,
# fixed photo-restore→restorer, kept face-swap (both hyphenated and unhyphenated resolve)
SUBDOMAINS=(
  "anime.symplyai.io"
  "avatar.symplyai.io"
  "baby.symplyai.io"
  "bgremover.symplyai.io"
  ...
  "productphoto.symplyai.io"
  "qr-art.symplyai.io"
  "qr-code.symplyai.io"
  "restorer.symplyai.io"
