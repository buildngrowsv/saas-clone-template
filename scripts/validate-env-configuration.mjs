...
const REQUIRED_VARS = [
  ...
  { name: "NEXT_PUBLIC_STRIPE_PUBLISHABLE_KEY", description: "Stripe publishable key (pk_live_* or pk_test_*) — used in stripe.ts client helper" },
  { name: "STRIPE_WEBHOOK_SECRET", description: "Stripe webhook signing secret (whsec_*)" },
  { name: "STRIPE_PRICE_BASIC", description: "Stripe price ID for Basic tier (server-side checkout)", aliases: ["STRIPE_PRICE_ID"] },
  { name: "STRIPE_PRICE_PRO", description: "Stripe price ID for Pro tier (server-side checkout)", aliases: ["STRIPE_PRICE_ID_PRO"] },
  { name: "NEXT_PUBLIC_STRIPE_PRICE_BASIC_MONTHLY", description: "Stripe price ID for Basic tier (pricing page display)" },
  { name: "NEXT_PUBLIC_STRIPE_PRICE_PRO_MONTHLY", description: "Stripe price ID for Pro tier (pricing page display)" },
